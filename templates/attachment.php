...
if ( !function_exists( 'themerex_template_attachment_theme_setup' ) ) {
	...
	function themerex_template_attachment_theme_setup() {
		themerex_add_template(array(
			'layout' => 'attachment',
			'mode'   => 'internal',
			'title'  => esc_html__('Attachment page layout', 'education'),
			...
			<div class="post_content">
				...
				if ($post_data['post_protected']) { 
					...
					if ($post_data['post_content']) {
						...
						esc_html_e('No image description ...', 'education');
					}
					wp_link_pages( array( 
						'before' => '<div class="nav_pages_parts"><span class="pages">' . esc_html__( 'Pages:', 'education' ) . '</span>',
						'after' => '</div>',
