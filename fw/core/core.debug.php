...
if (!function_exists('themerex_dco')) {	function themerex_dco(&$var)	{ 	if (is_user_logged_in()) themerex_debug_dump_screen($var); } }				// Console obj - output object structure on the screen
...
if (!function_exists('themerex_ddo')) {	function themerex_ddo(&$var)	{ 	if (is_user_logged_in()) return themerex_debug_dump_var($var); } }			// Return obj - return object structure
...
if (!function_exists('themerex_dfo')) {	function themerex_dfo(&$var)	{ 	if (is_user_logged_in()) themerex_debug_dump_file($var); } }				// File obj - output object structure into file debug.log
